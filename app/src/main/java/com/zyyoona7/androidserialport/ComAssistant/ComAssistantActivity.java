package com.zyyoona7.androidserialport.ComAssistant;
...
import com.zyyoona7.androidserialport.R;
import android_serialport_api.SerialPortFinder;
import com.zyyoona7.androidserialport.bean.AssistBean;
...
//						ComA=new SerialControl("/dev/s3c2410_serial0", "9600");
						...
						Log.e("comA", "port="+SpinnerCOMA.getSelectedItem().toString()+",rate="+SpinnerBaudRateCOMA.getSelectedItem().toString());
